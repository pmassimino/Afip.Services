...
namespace Afip.Services.Reference.WSAA
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://wsaahomo.afip.gov.ar/ws/services/LoginCms", ConfigurationName="Afip.Services.Reference.WSAA.LoginCMS")]
    public interface LoginCMS
    {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Afip.Services.Reference.WSAA.LoginFault), Action="", Name="fault")]
        Afip.Services.Reference.WSAA.loginCmsResponse loginCms(Afip.Services.Reference.WSAA.loginCmsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<Afip.Services.Reference.WSAA.loginCmsResponse> loginCmsAsync(Afip.Services.Reference.WSAA.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface LoginCMSChannel : Afip.Services.Reference.WSAA.LoginCMS, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<Afip.Services.Reference.WSAA.LoginCMS>, Afip.Services.Reference.WSAA.LoginCMS
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Afip.Services.Reference.WSAA.loginCmsResponse Afip.Services.Reference.WSAA.LoginCMS.loginCms(Afip.Services.Reference.WSAA.loginCmsRequest request)
        {
        ...
        {
            Afip.Services.Reference.WSAA.loginCmsRequest inValue = new Afip.Services.Reference.WSAA.loginCmsRequest();
            inValue.in0 = in0;
            Afip.Services.Reference.WSAA.loginCmsResponse retVal = ((Afip.Services.Reference.WSAA.LoginCMS)(this)).loginCms(inValue);
            return retVal.loginCmsReturn;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Afip.Services.Reference.WSAA.loginCmsResponse> Afip.Services.Reference.WSAA.LoginCMS.loginCmsAsync(Afip.Services.Reference.WSAA.loginCmsRequest request)
        {
            return base.Channel.loginCmsAsync(request);
        }
        
        public System.Threading.Tasks.Task<Afip.Services.Reference.WSAA.loginCmsResponse> loginCmsAsync(string in0)
        {
            Afip.Services.Reference.WSAA.loginCmsRequest inValue = new Afip.Services.Reference.WSAA.loginCmsRequest();
            inValue.in0 = in0;
            return ((Afip.Services.Reference.WSAA.LoginCMS)(this)).loginCmsAsync(inValue);
        }
